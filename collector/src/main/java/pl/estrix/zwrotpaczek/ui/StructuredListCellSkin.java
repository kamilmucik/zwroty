...
public class StructuredListCellSkin extends SkinBase<pl.estrix.zwrotpaczek.ui.StructuredListCell> {
    ...
    protected StructuredListCellSkin(pl.estrix.zwrotpaczek.ui.StructuredListCell control) {
        super(control);
    ...
    private static class StyleableProperties {
        private static final SkinPropertyBasedCssMetaData<pl.estrix.zwrotpaczek.ui.StructuredListCell, VPos> LEFT_CONTENT_ALIGNMENT = CssHelper.createSkinMetaDataForVPos("-fx-left-alignment", "leftContentAlignment", VPos.TOP);
        private static final SkinPropertyBasedCssMetaData<pl.estrix.zwrotpaczek.ui.StructuredListCell, VPos> RIGHT_CONTENT_ALIGNMENT = CssHelper.createSkinMetaDataForVPos("-fx-right-alignment", "rightContentAlignment", VPos.TOP);
        private static final SkinPropertyBasedCssMetaData<pl.estrix.zwrotpaczek.ui.StructuredListCell, HPos> CONTENT_FOR_PREF_HEIGHT = CssHelper.createSkinMetaDataForHPos("-fx-height-rule", "componentForPrefHeight", HPos.CENTER);
        private static final SkinPropertyBasedCssMetaData<pl.estrix.zwrotpaczek.ui.StructuredListCell, Number> SPACING = CssHelper.createSkinMetaData("-fx-spacing", StyleConverter.getSizeConverter(), "spacing", 0);
        private static final SkinPropertyBasedCssMetaData<pl.estrix.zwrotpaczek.ui.StructuredListCell, Pos> CENTER_CONTENT_ALIGNMENT = CssHelper.createSkinMetaDataForPos("-fx-center-alignment", "centerContentAlignment", Pos.TOP_LEFT);

        private static final List<CssMetaData<? extends Styleable, ?>> STYLEABLES = CssHelper.createCssMetaDataList(pl.estrix.zwrotpaczek.ui.StructuredListCell.getClassCssMetaData(), LEFT_CONTENT_ALIGNMENT, RIGHT_CONTENT_ALIGNMENT, CONTENT_FOR_PREF_HEIGHT, SPACING, CENTER_CONTENT_ALIGNMENT);
    }
}