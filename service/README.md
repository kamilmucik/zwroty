...
mvn versions:set -DnewVersion=2.5.1 -DprocessAllModules -DgenerateBackupPoms=false
...
scp return-parcel-docker/return-parcel-docker-server/target/dependencies/return-parcel-app-2.5.1.war ubuntu@e-strix.pl:/home/ubuntu/wp/releases/megapack/2.5.1/ROOT.war
