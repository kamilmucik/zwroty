...
@Component
@NoArgsConstructor
public class ScanProductLazyDataModel  extends LazyDataModel<ShipmentProductDto> {
    ...
    public ScanProductLazyDataModel(ShipmentService storeService, Long shipmentId,String tableSearch) {
